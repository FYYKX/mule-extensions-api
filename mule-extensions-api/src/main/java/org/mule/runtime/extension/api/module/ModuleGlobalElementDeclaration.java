 ...
 * @since 1.0
 */
public interface ModuleGlobalElementDeclaration {
   ...
   * when this value is an {@link ModuleGlobalElementDeclaration}.
   *
   * @param visitor the visitor
   */
  void accept(ModuleGlobalElementDeclarationVisitor visitor);
