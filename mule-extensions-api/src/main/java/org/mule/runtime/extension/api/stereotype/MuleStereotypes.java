...
public final class MuleStereotypes {
  ...
  public static final StereotypeDefinition OPERATION_DEFINITION = new OperationStereotype();
  ...
  public static final StereotypeModel OPERATION = newStereotype(OPERATION_DEFINITION.getName(), STEREOTYPE_NAMESPACE).build();
